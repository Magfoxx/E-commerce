    ...
    <section className="max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[667px] w-full mb-10 relative">
      <div className="bg-white p-3 rounded-2xl max-w-[233px] relative top-8 xl:top-12">
        ...
        <p className="text-[13px]">
          <b className="uppercase">Débloque </b>ton meilleur look, un clic à la
          fois. Change ton style dès maintenant !
        </p>
      </div>
      <div className="mt-12 sm:mt-20 max-w-[777px]">
        <h5 className="flex items-baseline gap-x-2 uppercase text-secondary medium-18">
          Collection moderne <BsFire />
        </h5>
        <h1 className="h1 capitalize max-w-[722px]">
          Chaque clic vous rapproche de la perfection. Achetez maintenant !
        </h1>
        <div className="flex">
          <Link className="bg-white text-xs font-medium pl-5 rounded-full flexCenter gap-x-2 group">
            Consultez notre collection moderne
