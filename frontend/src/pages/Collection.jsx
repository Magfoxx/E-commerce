  ...
  return (
    <div className="max-padd-container !px-0">
      <div className="flex flex-col sm:flex-row gap-8 mb-16">
        {/* Option de filtre  */}
        <div className="min-w-72 bg-primary p-4 pt-8 pl-6 lg:pl-12 rounded-r-xs">
          <ShowSearch />
          <div className="pl-5 py-3 mt-6 bg-white rounded-xl">
            <h5 className="h5 mb-4">Catégories</h5>
            <div className="flex flex-col gap-2 text-sm font-light">
              {["Homme", "Femme", "Enfants"].map((cat) => (
          ...
          <div className="pl-5 py-3 mt-6 bg-white rounded-xl">
            ...
            <div className="flex flex-col gap-2 text-sm font-light">
              {["Hauts", "Bas", "Vêtements d'hiver"].map((subCat) => (
                <label
                  key={subCat}
          ...
          <div className="px-4 py-3 mt-6 bg-white rounded-xl">
            <h5 className="h5 mb-4">Trier par</h5>
            <select
              onChange={(e) => setSortType(e.target.value)}
              className="border border-slate-900/5 ontline-none text-gray-30 medium-14 h-8 w-full rounded px-2"
            >
              <option value="relevant">Pertinences</option>
              <option value="low">Prix croissant</option>
              <option value="hight">Prix décroissant</option>
            </select>
          </div>
        </div>
        {/* Coté droit */}
